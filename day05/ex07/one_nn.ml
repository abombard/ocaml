...
let one_nn (radars : radar list) (radarCmp : radar) =
    ...
    (* print_endline "radarCmp: ";
    Array.iter print_float_array (fst radarCmp);
    print_endline "";
    print_endline "nearest: ";
    Array.iter print_float_array (fst !nearest);
    print_endline ""; *)
    snd !nearest
...
let () =
    ...
    print_endline (one_nn radars radarCmp)
